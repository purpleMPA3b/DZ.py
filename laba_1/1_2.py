...
sorted_array_bubble = bubbleteea(array_for_bubble)
bubbleteea = time.time() - start_time

"""time --- сортировка с составными ключами"""
start_time = time.time()
sorted_array_quick = sort_and_key(array_for_quick, key_func=lambda x: x, reverse=True)
quick_sort_time = time.time() - start_time


"""результаты"""
print(f"Время быстрой сортировки с составными ключами (по убыванию): {quick_sort_time:.2f} секунд")
